...
ADDITIONAL_OBJC_LIBS = -lGL -lBulletCollision -lLinearMath
...
Core3DExample_RESOURCE_FILES = item_sphere_damage.dds item_sphere_damage.octree.snz item_sphere_shield.dds item_sphere_shield.octree.snz MainMenu.xib
